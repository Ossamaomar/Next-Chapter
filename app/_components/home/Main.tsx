...
export default function Main() {
  ...
  return (
    <div className="relative min-h-[calc(100vh-5rem)]  px-8 py-4 flex flex-col md:flex-row justify-center items-center bg-gradient-to-r from-amber-50 to-emerald-100">
      <div
        ref={mainRef}
